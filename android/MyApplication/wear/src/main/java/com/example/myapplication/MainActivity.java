...
import com.example.myapplication.DataLayerScreen.CapabilityDiscoveryData;
        ...
        for (DataEvent event : dataEvents) {
            if (event.getType() == DataEvent.TYPE_CHANGED) {
                ...
                if (DataLayerListenerService.IMAGE_PATH.equals(path)) {
                    ...
                    DataMapItem dataMapItem1 = DataMapItem.fromDataItem(event.getDataItem());
                    mCustomRecyclerAdapter.appendToDataEventLog(
                            "DataItem Changed", String.valueOf(dataMapItem1.getDataMap().getInt("count1")));
                } else {
